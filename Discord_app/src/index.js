...
for (const file of commandFiles) {
  ...
  if ("data" in command && "execute" in command) {
    ...
    console.log(
      `[WARINING]: CMD at ${filePath} missing a required "data" or "execute" property.`
    );
  }
}
...
client.on("ready", async () => {
  ...
  await mongoose.connect(process.env.dbToken);      //connect to MongoDB
  console.log(mongoose.connection.readyState);      //confirm connection
});
